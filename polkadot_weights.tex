...
\section{Motivation}
\syed{}{this could be expanded into a nice intro with in a way that the problem and solution become clearer, discussing alternative, ...}
...
\syed{}{block ration is a part of the problem so it is better to come before introducing the weight solution}
...
\syed{}{it is good to describe the document structure here or somewhere, section 1 blah section2 bloh}

\section{Fundamentals}
\syed{}{some intro about this section}
...
Assigning weights based on theoretical performance such as big O notation proves to be a complex task
which at the same time does not provide sufficient granuality in the practical setting partially due to imprecision in back-end systems, internal communication within the Runtime and design choices in the software. 

In absence of a reliable theoretical framework for weight assignement, we benchmark the resource consumption of all available Runtime functions, which create and execute extrinsics. This is done through executing these function over a large collection of input parameters.
